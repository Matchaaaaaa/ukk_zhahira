...
<div class="card bg-transparent">
    <div class="card-body">
        <div class="row">
            ...
            <body style="background-image: url('assets/img/img3.jpg');" class="bg-dark">
                <div class="col-md-12">
                    <form method="post">
                        <?php
                        if (isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "INSERT INTO buku(id_buku,id_kategori,judul,penulis,penerbit,tahun_terbit) values ('', '$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit')");
