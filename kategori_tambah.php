...
<div class="card">
            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <button type="submit" class="btn btn-primary" name="submit" value="submit"><i
                                    class="fa-solid fa-floppy-disk"></i> Simpan</button>

                            <a href="?page=kategori" class="btn btn-secondary"><i class="fa-solid fa-xmark"></i>
                                Kembali</a>
    ...
    <div class="o" style="margin-bottom: 200px;">
        <p> </p>
    </div>
</div>