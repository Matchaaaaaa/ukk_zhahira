...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <a href="?page=peminjaman_tambah" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Peminjaman</a>
                <br><br>
                        ...
                        <tr>
                            <div class="btn-group" role="group" aria-label="Actions" style="padding: 10px;">
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col">
                                            <a href="?page=peminjaman_ubah&&id=<?= $data['id_peminjaman']; ?>"
                                                class="btn btn-info" style=" border-radius: 20px;">Ubah</a>
                                        </div>
                                        <div class="col">
                                            <a onclick="return confirm('Apakah anda yakin menghapus data ini?');"
                                                href="?page=peminjaman_hapus&&id=<?= $data['id_peminjaman']; ?>"
                                                class="btn btn-warning" style=" border-radius: 20px;">Hapus</a>
                                        </div>
                                        <div class="col">
                                            <form method="post" action="simpan_koleksi.php" style="">
                                                ...
                                                <button type="submit" name="simpan" class="btn btn-secondary"
                                                    ...
                                                    onclick="return confirm('Apakah anda yakin menyimpan data ini?');">simpan</button>
                                            </form>
                                        </div>
                                    </div>
                                </td>
